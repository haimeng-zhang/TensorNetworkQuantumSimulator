...
function main(χ::Int, ny::Int, mu::Float64, δt::Float64, Δ::Float64)
    ...
    t = 0
    f = "/mnt/home/jtindall/ceph/Data/Transport/Chain/HeisenbergPictureSqrtApproach/ny"*string(ny)*"maxdim"*string(χ)*"dt"*string(δt)*"mu"*string(mu)*"Delta"*string(Δ)
...
χ, ny, mu, δt, Δ =64, 100, 0.1, 0.1, 1.0
main(χ, ny, mu, δt, Δ)
